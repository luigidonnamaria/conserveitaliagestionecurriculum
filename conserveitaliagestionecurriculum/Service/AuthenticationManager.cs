...
namespace conserveitaliagestionecurriculum.Service
{
    public class AuthenticationManager : IDisposable
    {
        ...
        private  string defaultAADAppId = "";//"7a81aeb8-713d-43b7-b135-9638d4d34a35";
        ...
        public ClientContext GetContext(Uri web, string userPrincipalName, SecureString userPassword, string clientAppId)
        {
            var context = new ClientContext(web);
            defaultAADAppId = clientAppId;
